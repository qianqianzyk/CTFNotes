[脚本](https://github.com/livz/cloacked-pixel)

```kali-linux
python lsb.py extract 1.png 1.txt 123456
```

注意:此脚本在python3中无法使用,请使用conda创建python2环境(具体详见Misc/补充知识/conda),然后执行以下命令

```kali-linux
python2 /你/的/脚/本/路径 extract /你的/图片/路径 /解出/文件/路径 123456
```
